...
\hypersetup{
  pdftitle={A doctoral thesis title},
  pdfauthor={佐々木 毅然},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\thesistitle{A doctoral thesis
title} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Dr.~Ashok
...
\author{佐々木
毅然} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\includegraphics[height=3cm]{images/kendailogo.png} % University/department logo
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-cars-1.pdf}}
