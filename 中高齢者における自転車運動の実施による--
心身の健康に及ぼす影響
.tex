...
\hypersetup{
  pdftitle={中高齢者における自転車運動の実施による 心身の健康に及ぼす影響},
  pdfauthor={佐々木~毅然},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\thesistitle{中高齢者における自転車運動の実施による\\
心身の健康に及ぼす影響} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{兵庫~太郎~教授} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\pandocbounded{\includegraphics[keepaspectratio]{Chapters/Chapter1_files/figure-pdf/fig-cars-1.pdf}}
